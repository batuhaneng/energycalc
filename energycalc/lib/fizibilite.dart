...
class Fizibilite extends StatefulWidget {
  const Fizibilite({Key? key}) : super(key: key);

  @override
  _FizibiliteState createState() => _FizibiliteState();
}

class _FizibiliteState extends State<Fizibilite> {
  @override
      ...
      child: Container(
        child: Padding(
          ...
          child: Center(
            ...
            animatedTexts: [
              ColorizeAnimatedText(
                'Online Fizibilite Yakında Hizmete Girecektir.',
                textStyle: colorizeTextStyle,
                colors: colorizeColors,
              ),
            ],
